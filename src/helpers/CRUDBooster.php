    ...
    public static function sendEmail($config = [])
    {
        ...
        try {
            ...
            DB::table('cms_email_logs')->insert([
                ...
                'from'  => $template->from_email ?: CRUDBooster::getSetting('email_sender'),
                'to'    => $to,
                'bcc'   => $template->cc_email,
                'subject'=> $subject,
                'body'  => $html,
                'headers'=> '',
            ...
            CRUDBooster::redirectBack('Whoops, Sedang terjadi gangguan pada email server, silahkan mencoba kembali beberapa saat lagi','danger');
