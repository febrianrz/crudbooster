        ...
        <div class='main-menu'>
            ...
            <ul class="sidebar-menu">
                ...
                @if(CRUDBooster::isSuperadmin())
                    ...
                    <li class="{{ (Request::is(config('crudbooster.ADMIN_PATH').'/log_email*')) ? 'active' : '' }}"><a href='{{ url(config('crudbooster.ADMIN_PATH')."/log_email") }}'><i
                            class='fa fa-flag'></i> <span>{{ __('Email Log') }}</span></a></li>
