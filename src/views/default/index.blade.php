        ...
        <div class="box-body table-responsive no-padding">
            <table class='table table-bordered'>
                <tbody>
                    ...
                    @if(!isset($v['showRowIf']) || $v['showRowIf'])
                    <tr>
                        ...
                        <td>
                            ...
                            @if($v['showIf'])
                            @if($v['type'] == "url")
                            <a href="{{ $v['url'] }}" target="{{ $v['target'] }}"><i class="fa {{ $v['icon'] }}"></i> {{ $v['value'] }}</a>
                            @elseif($v['type'] == "button") 
                            <a href="{{ $v['url'] }}" class="btn btn-{{ $v['color'] }} {{ $v['class'] }}" data-title="{{ $v['title'] }}"><i class="fa {{ $v['icon'] }}"></i> {{ $v['value'] }}</a>
                            @endif
                            @endif
                            @endif
                        </td>
