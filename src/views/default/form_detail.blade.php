...
?>
@if(file_exists(base_path('/vendor/febrianrz/crudbooster/src/views/default/type_components/'.$type.'/asset.blade.php')))
...
<div class='table-responsive'>
    <table id='table-detail' class='table table-striped'>
        ...
        $file_location = base_path('vendor/febrianrz/crudbooster/src/views/default/type_components/'.$type.'/component_detail.blade.php');
